...
<head>
    ...
    <body>
<form class="row g-3" method="post" action="inserisci_risultato_tampone.php">
    <div class="col-md-4">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="risultato" id="risultato">
            <label class="form-check-label" for="positivo">
              POSITIVO
            </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="radio" name="risultato" id="risultato" checked>
